...
def createPessoa(request):
    ...
    # O caractere '_' está substituindo o espaço em branco pois quando o sobrenome é enviado para o formulario
    # cada espaço em branco esta sendo considerado commo fim do valor atual e a proxima palavra está sendo considerada como um novo atributo
